...
import type { AppSettings, Order, OrderDraft, OrderStatus, ProgramTransferPreview, ProgramType, User } from '../domain/types'
...
import { AdminProgramTransferModal } from './AdminProgramTransferModal'
...
export function OrdersPage({ user, orders, settings, now, programType, onCreateOrder, onCreateOrdersBulk, onStatusChange, onProgramTransferPreview, onProgramTransfer, onArchiveOrder, onRestoreOrder }: {
  user: User
  orders: Order[]
  ...
  onProgramTransferPreview: (order: Order, targetProgram: ProgramType) => Promise<ProgramTransferPreview>
  onProgramTransfer: (order: Order, targetProgram: ProgramType, reason: string) => Promise<void>
