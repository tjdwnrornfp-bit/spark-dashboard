...
export function Modal({ title, description, children, footer, onClose, className = '' }: { title: string; description?: string; children: ReactNode; footer: ReactNode; onClose: () => void; className?: string }) {
  return (
